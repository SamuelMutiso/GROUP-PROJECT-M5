    ...
    <div>
      ...
      >
        ...
        <div className={`section-wrap relative py-section-lg ${theme.textClass}`}>
          <h1 className="max-w-xl text-3xl sm:text-4xl">{theme.heading}</h1>
      ...
      {/* Trust strip - same three highlights regardless of event type. A
          left border accent stands in for an icon here instead of an emoji
          - keeps the visual grouping without relying on emoji glyphs. */}
